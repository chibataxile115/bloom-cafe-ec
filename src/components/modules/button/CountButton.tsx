    ...
    <div className="flex flex-col">
      <div className="flex">
        ...
        <button
          ...
          className="ml-4 mr-4 box-content h-3 w-3 rounded-full border-2 border-black bg-white p-2"
        ...
        <button
          ...
          className="mr-4 box-content h-3 w-3 rounded-full border-2 border-white bg-black p-2"
